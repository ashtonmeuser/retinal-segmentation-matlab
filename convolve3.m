function [output] = convolve3(image, FOVmaskImage, kSize, func)
...
FOVmaskImage = pad(FOVmaskImage, padSize, 0);
...
for y = padSize + 1:h + padSize
    for x = padSize + 1:w + padSize
        ...
        FOVneighborhood = FOVmaskImage(y - padSize:y + padSize, x - padSize:x + padSize);
        ypos = y - padSize;
        xpos = x - padSize;
        [S, S0, I] = func(neighborhood, FOVneighborhood); %using generateMaskArrays function call
